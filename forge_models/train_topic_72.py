#!/usr/bin/env python3
"""Topic 72 — 1h BTC/USD log-return.

Target: log_return = ln(price_{t+1h} / price_t). Submit the log-return itself.
All the train/evaluate/calibrate/export machinery lives in
``forge_models.common.runner``; this file is just the topic's config.
    ...
    PREDICT_PKL=models/predict_topic_72.pkl TOPIC_ID=72 python notebooks/deploy_worker.py
"""
